      ...
      <div className='flex items-center justify-center h-screen'>
        <div className='xl:w-[1200px] lg:w-[850px]  shadow-xl rounded-3xl mr-4 ml-4'>
          <div className='flex justify-between md:h-[600px]'>
            <div className='xs:hidden lg:flex  xl:w-[570px] lg:w-[400px]  bg-white bg-opacity-25  backdrop-blur-sm rounded-l-3xl  flex items-center justify-center '>
            ...
            <div className='p-16 bg-white md:flex-1 sm:w-[540px] rounded-r-3xl xs:rounded-l-3xl lg:rounded-l-none'>
              <form>
                <div className='mb-5'>
                  <h1 className='text-3xl font-semibold leading-7 '>Sign Up</h1>
                  <span className='text-lg font-normal '>Let Get Started</span>
                </div>
                <Input id='full name' label='Full Name' />
              ...
              <Drawer />
              <WithGoggle>Sign up with Google</WithGoggle>
              <div>
